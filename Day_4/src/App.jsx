          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            <div>
              ...
              <input
                type='email'
                value={email}
                className='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring focus:ring-blue-500'
            ...
            <div className='flex justify-between space-x-4 pt-2'>
              <button
                ...
                className='w-1/2 bg-pink-500 text-white py-3 rounded-lg hover:bg-blue-300 transition duration-200'
              >
                LOGIN
              </button>
              ...
              <button
                ...
                className='w-1/2 bg-purple-600 text-white py-3 rounded-lg hover:bg-yellow-400 transition duration-200'
              >
                FORGOT PASSWORD
              </button>
            </div>
